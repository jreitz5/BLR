    ...
    <div class="mr-auto"></div>
      <ul class="navbar-nav my-2 my-lg-0">
        <li class="nav-item active">
          <a class="nav-link active" href="/home" style="color:black;font-size:2vw;font-family:Palatino,serif;margin: 5px;"><h1>Home</h1><span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/submit_review" style="color:black;font-size:2vw;font-family:Palatino,serif;margin: 5px;"><h1>Submit A Review</h1><span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/feedback" style="color:black;font-size:2vw;font-family:Palatino,serif;margin: 5px;"><h1>Leave Feedback</h1><span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
